...
def tokenize_pairs(input_data, output_data):
    input_data = input_data.to_tensor()
    output_data = output_data.to_tensor()
...
def transformer_workflow(initial_data, target_data):
    ...
    transformer = Transformer(
        ...
        num_heads=num_heads,
        dff=dff,
        input_vocab_size=1000,  #tokenizers.pt.get_vocab_size().numpy(),
        target_vocab_size=1000,  #tokenizers.en.get_vocab_size().numpy(),
        pe_input=1000,
        pe_target=1000,
        rate=dropout_rate)
