...
#path = '/Users/sven/kohalikTree/Data/AIRSCS/spectral/'
#path = '/Users/svennomm/kohalikTree/Data/AIRSCS/spectral_1/'  # to read data submitted on 10.12.2021
#path = '/Users/svennomm/kohalikTree/Data/AIRSCS/spectral_2_reprocessed/'  # this is for the large data set provided end 2021-jan2022

#path = '/Users/sven/kohalikTree/Data/AIRSCS/spectral/'
#path = '/home/sven/kohalikTree/Data/AIRSCS/spectral_1/'  # to read data submitted on 10.12.2021
path = '/home/sven/kohalikTree/Data/AIRSCS/spectral_2/'  # this is for the large data set provided end 2021-jan2022
...
#initial_data_file = path + 'X30_sarspec_hgh_order_2_winx_1024_clean_reprocessed_.csv' # this and the following row are for the data xx.12.2021 - xx.01.2022
#target_data_file = path + 'X30_wavespec_hgh_order_2_winx_1024_clean_reprocessed_.csv'

#initial_data_file = path + 'sarspec_hgh_order_2_winx_256_clean_reprocessed_.csv' # this and the following row are for the data xx.12.2021 - xx.01.2022
#target_data_file = path + 'wavespec_hgh_order_2_winx_256_clean_reprocessed_.csv'
