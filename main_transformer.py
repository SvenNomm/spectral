# this is the the main file for transformer case the spectral project
...
from preprocessing_module import initial_formatting_3
...
from transformers_support import transformer_workflow
...
bs = transformer_workflow(initial_data, target_data)
